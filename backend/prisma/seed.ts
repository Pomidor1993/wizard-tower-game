...

{
  ...
  element: "earth", rarity: "common", damage: 0, spellPool: "chaotic",
  isDirectional: false,
  reqEarthMagic: 5, reqWaterMagic: 5, reqAirMagic: 5, reqFireMagic: 5,
  spellBook: false,
...

{
  ...
  isDirectional: false,
  reqFireMagic: 15, reqWaterMagic: 15, reqAirMagic: 15, reqEarthMagic: 15,
  spellBook: false,
  special: "Jego ciało pokrywają różne znaki, które absorbują część otrzymywanych obrażeń z magii wody, ziemi, ognia i powietrza.",
  statusEffects: fx([
...

{
  ...
  isDirectional: false,
  reqFireMagic: 25, reqWaterMagic: 25, reqAirMagic: 25, reqEarthMagic: 25,
  spellBook: false,
  special: "Jego ciało pokrywają różne znaki, które absorbują część otrzymywanych obrażeń z magii wody, ziemi, ognia i powietrza.",
  statusEffects: fx([
...

{
  ...
  element: "basic", rarity: "uncommon", damage: 0, spellPool: "chaotic",
  isDirectional: false,
  reqEarthMagic: 5, reqWaterMagic: 5,
  spellBook: false,
