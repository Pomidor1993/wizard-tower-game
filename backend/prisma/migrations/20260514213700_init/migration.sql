...
CREATE TABLE "Character" (
    ...
    "fireMagic" INTEGER NOT NULL DEFAULT 0,
    "earthMagic" INTEGER NOT NULL DEFAULT 0,
    "airMagic" INTEGER NOT NULL DEFAULT 0,
    "waterMagic" INTEGER NOT NULL DEFAULT 0,
    "chaosMagic" INTEGER NOT NULL DEFAULT 0,
    "energyMagic" INTEGER NOT NULL DEFAULT 0,
    "lifeMagic" INTEGER NOT NULL DEFAULT 0,
    "deathMagic" INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE "Item" (
    ...
    "bonusFireMagic" INTEGER NOT NULL DEFAULT 0,
    "bonusWaterMagic" INTEGER NOT NULL DEFAULT 0,
    "bonusEarthMagic" INTEGER NOT NULL DEFAULT 0,
    "bonusAirMagic" INTEGER NOT NULL DEFAULT 0,
    "bonusChaosMagic" INTEGER NOT NULL DEFAULT 0,
